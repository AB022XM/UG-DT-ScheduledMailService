...
To build the final jar and optimize the ScheduledMailService application for production, run:
...
Then navigate to [http://localhost:9225](http://localhost:9225) in your browser.

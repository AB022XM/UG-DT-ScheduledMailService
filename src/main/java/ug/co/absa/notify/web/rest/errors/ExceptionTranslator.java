package ug.co.absa.notify.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof ug.co.absa.notify.service.EmailAlreadyUsedException ||
            ex instanceof ug.co.absa.notify.service.UsernameAlreadyUsedException
        ) {
        ...
        if (ex instanceof ug.co.absa.notify.service.InvalidPasswordException) return (ProblemDetailWithCause) new InvalidPasswordException()
            .getBody();
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "ug.co.absa.notify");
    }
}
